"""执行器：轮执行全链 / settle 比对 / 围栏 / 续约 / 扩展签名 / 僵尸对账（Phase 6）。

Phase 9 T6 拆分：本文件保留「轮执行与围栏面」；T6b 终止面（bounded-stop /
terminator 真件 / 注销钩子 / 生产接线 / riders）见
test_v2_task_executor_termination.py；共享助手见 v2_executor_helpers。
"""
